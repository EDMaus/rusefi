...
AUTOUPDATE_CONSOLE_JAR = $(CONSOLE_FOLDER)/rusefi_autoupdate.jar
...
$(LEGACY_CONSOLE_LAUNCHER): ../misc/console_launcher/rusefi_autoupdate.exe | $(CONSOLE_FOLDER)
	cp $< $@

$(AUTOUPDATE_CONSOLE_JAR): $(CONSOLE_JAR) | $(CONSOLE_FOLDER)
	cp $< $@
